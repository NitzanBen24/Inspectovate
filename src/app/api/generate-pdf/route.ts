...
import { formatDateRTL, getImageBase64 } from '@/app/server/utils';
...
async function _sendDynamicForm(payload: any): Promise<any> {
    try {
        ...
        return await _handleDynamicSend(payload);
...
export async function POST(req: NextRequest) {
    ...
    try {
        ...
        const result = await _sendDynamicForm(payload);
