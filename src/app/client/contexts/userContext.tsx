...
export const UserContext = createContext<{
  ...
  export const UserProvider = ({ children }: { children: ReactNode }) => {
    const [user, setUser] = useState<User>({ isLoggedIn: false, id:0, name:'', email: '' , role:'', company_id: -1});
    ...
    const logOut = () => setUser({ isLoggedIn: false, id:0, name:'', email: '' ,role: 'role', company_id: -1});
